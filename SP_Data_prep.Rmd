...
unique(shell.site.crab$site_name)
unique(ott.dat.sum$site)

test <- ott.dat.sum %>% 
  filter(site != "Hauti Island" & site != "N Fish Egg Island")

shell.site.crab$ott_dens_avg <- test$dens_avg


ggplot(shell.site.crab) +
  geom_point(aes(x = ott_dens_avg, y = freq))
```
